...
export const marinescu: TenantData = {
  meta: {
    id: 'marinescu',
  ...
  mentions: [
    { id: 'm01', source: 'facebook', author: 'Groupe « Clujeni adevărați »', excerpt: 'On nous cache la vérité : l’argent européen de la ville a disparu et Marinescu refuse de publier les comptes. Partagez avant que ce soit supprimé.', sentiment: 'negatif', reach: 18400, time: '19/07 08:47', topic: 'Finances municipales' },
    { id: 'm02', source: 'telegram', author: 'Canal « Cluj Realitatea »', excerpt: 'DOCUMENTS EXCLUSIFS sur le détournement des fonds de la mairie de Cluj. Le maire sortant doit répondre.', sentiment: 'negatif', reach: 9800, time: '19/07 08:12', topic: 'Finances municipales' },
    { id: 'm03', source: 'presse', author: 'Monitorul de Cluj', excerpt: 'Visite du marché Mihai Viteazul : le maire sortant annonce la modernisation de trois halles supplémentaires d’ici 2027. Accueil chaleureux des commerçants.', sentiment: 'positif', reach: 42100, time: '19/07 07:55', topic: 'Bilan du mandat' },
    { id: 'm04', source: 'x', author: '@cluj_watch', excerpt: 'Rappel : en 2019 Marinescu promettait un tramway vers Florești. Toujours rien. #Cluj', sentiment: 'negatif', reach: 5600, time: '19/07 07:31', topic: 'Transport' },
    { id: 'm05', source: 'facebook', author: 'Page officielle campagne', excerpt: 'Merci aux 300 bénévoles mobilisés ce week-end dans les quartiers Mărăști et Gheorgheni. La campagne de terrain continue dimanche.', sentiment: 'positif', reach: 12300, time: '18/07 20:14', topic: 'Campagne de terrain' },
    { id: 'm06', source: 'forum', author: 'clujforum.ro — fil « Élections 2026 »', excerpt: 'Sondage informel du forum : Marinescu 41 %, en baisse de 6 points depuis juin. Débat houleux sur la gestion du budget.', sentiment: 'neutre', reach: 3100, time: '18/07 19:48', topic: 'Sondages' },
    { id: 'm07', source: 'presse', author: 'Știri de Cluj (TV)', excerpt: 'Débat municipal : le maire défend un excédent budgétaire de 42 M lei et promet la publication intégrale des audits européens.', sentiment: 'neutre', reach: 38700, time: '18/07 18:20', topic: 'Finances municipales' },
    { id: 'm08', source: 'instagram', author: '@cluj.tineret', excerpt: 'Story : affiches de campagne Marinescu dégradées près de l’université. Photos à l’appui, signalement déposé.', sentiment: 'neutre', reach: 8900, time: '18/07 16:02', topic: 'Campagne de terrain' },
    { id: 'm09', source: 'facebook', author: 'Groupe « Mănăștur în mișcare »', excerpt: 'Réunion publique jeudi : les habitants veulent des réponses sur la sécurité au quartier, pas des promesses.', sentiment: 'neutre', reach: 2700, time: '18/07 14:36', topic: 'Sécurité' },
    { id: 'm10', source: 'x', author: '@andra_cluj', excerpt: 'La visite au marché de ce matin était sincère et bien menée. Le bilan sur les halles parle de lui-même.', sentiment: 'positif', reach: 1900, time: '18/07 11:15', topic: 'Bilan du mandat' },
  ],
